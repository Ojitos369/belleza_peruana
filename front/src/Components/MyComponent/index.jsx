    ...
    return (
        <Fragment>
            <div className='flex flex-wrap justify-center w-full'>
                <h2 className={`text-center w-full mt-3 font-bold text-3xl ${ls?.theme === 'black' ? 'text-white' : 'text-black'}`}
                >
                    Actual theme: {ls.theme}
                </h2>
                <h4 className={`text-center w-full mt-3 font-bold text-xl ${ls?.theme === 'black' ? 'text-white' : 'text-black'}`}
                >
                    {s?.init?.saludo || ":'c"}
                </h4>
            </div>
